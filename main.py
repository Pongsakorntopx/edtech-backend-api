...
async def generate_lesson_for_cohort(strand: str, grade: str, rooms: List[str], topic: str, indicators: str, rules: str, ref_text: str, goal: str, detail_level: str):
    ...
    **กฎเหล็กด้านเนื้อหาและรูปแบบ (CRITICAL - บังคับใช้อย่างเคร่งครัด):**
    1. **ห้ามใช้เครื่องหมายอักขระพิเศษหรือ Markdown เด็ดขาด:** ห้ามพิมพ์เครื่องหมายดอกจัน (*) สำหรับตัวหนาหรือตัวเอียง ห้ามใช้เครื่องหมาย (#) หรืออักษรแปลกๆ ให้พิมพ์เป็น "ข้อความธรรมดา (Plain Text)" ที่จัดย่อหน้าเว้นวรรคอย่างถูกต้องเพื่อให้อ่านง่ายที่สุด
